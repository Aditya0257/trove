...
import com.trove.config.IngestProperties;
import com.trove.entity.IngestToken;
import com.trove.repository.IngestTokenRepository;
...
@Service
public class IngestTokenServiceImpl implements IngestTokenService {

    private final IngestTokenRepository repository;
    private final IngestProperties props;
    private final SecureRandom random = new SecureRandom();

    public IngestTokenServiceImpl(IngestTokenRepository repository, IngestProperties props) {
