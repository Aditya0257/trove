...
@Service
public class NeuronRateServiceImpl implements NeuronRateService {

    private static final Logger log = LoggerFactory.getLogger(NeuronRateServiceImpl.class);
    ...
    public NeuronRateServiceImpl(CloudflareProperties cf, ObjectMapper mapper,
