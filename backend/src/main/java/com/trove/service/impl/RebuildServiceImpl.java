...
public class RebuildServiceImpl implements RebuildService {
    ...
    private static final Logger log = LoggerFactory.getLogger(RebuildServiceImpl.class);
    ...
    public RebuildServiceImpl(StorageService storageService, DocumentRepository documentRepository,
