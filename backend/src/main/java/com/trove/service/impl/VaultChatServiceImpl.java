...
@Service
public class VaultChatServiceImpl implements VaultChatService {

    private static final Logger log = LoggerFactory.getLogger(VaultChatServiceImpl.class);
    ...
    public VaultChatServiceImpl(ChatProperties props, EmbeddingService embeddings, SpaceAuthorization authorization,
