...
public class ImportServiceImpl implements ImportService {
    ...
    public ImportServiceImpl(StorageService storageService, RebuildService rebuildService,
    ...
    public RebuildSummary importZip(byte[] zipBytes) {
        ...
        try {
            ...
            RebuildSummary summary = rebuildService.rebuild();
