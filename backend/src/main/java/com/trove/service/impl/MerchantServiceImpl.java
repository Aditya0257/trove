...
import com.trove.repository.MerchantAliasRepository;
...
public class MerchantServiceImpl implements MerchantService {
    ...
    public MerchantServiceImpl(MerchantRepository merchantRepository, MerchantAliasRepository aliasRepository) {
