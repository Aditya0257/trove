...
import com.trove.dto.ExtractionAttempt;
...
public class ExtractionEngine {
    ...
    /** AI tokens billed for this read, if the provider stashed them in extra.aiTokens. */
    private static Integer tokensOf(ExtractionResult result) {
